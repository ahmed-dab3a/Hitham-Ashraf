...
export const EXERCISES: ExerciseData[] = [
  // ============== CHEST (Push) ==============
  {
    id: 'c1', name: 'Flat Bench Press', nameAr: 'ضغط بنش مستوي بالبار', muscle: 'Chest', secondaryMuscles: ['Triceps', 'Shoulders'],
    ...
    gifUrl: `${BASE}/Barbell_Bench_Press/images/0.jpg`
  },
  {
    id: 'c2', name: 'Incline Dumbbell Press', nameAr: 'ضغط بنش عالي بالدمبلز', muscle: 'Chest', secondaryMuscles: ['Shoulders', 'Triceps'],
    ...
    gifUrl: `${BASE}/Dumbbell_Incline_Bench_Press/images/0.jpg`
  },
  {
    id: 'c3', name: 'Push Ups', nameAr: 'ضغط', muscle: 'Chest', secondaryMuscles: ['Triceps', 'Shoulders', 'Core'],
    ...
    gifUrl: `${BASE}/Push-up/images/0.jpg`
  },
  {
    id: 'c4', name: 'Cable Crossover', nameAr: 'تفتيح بالكابل', muscle: 'Chest', secondaryMuscles: ['Shoulders'],
    ...
    gifUrl: `${BASE}/Cable_Crossover/images/0.jpg`
  },
  {
    id: 'c5', name: 'Dumbbell Fly', nameAr: 'تفتيح بالدمبلز مستوي', muscle: 'Chest', secondaryMuscles: ['Shoulders'],
    equipment: 'Dumbbells', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Dumbbell_Fly/images/0.jpg`
  },
  {
    id: 'c6', name: 'Decline Bench Press', nameAr: 'ضغط مقلوب بالبار', muscle: 'Chest', secondaryMuscles: ['Triceps', 'Shoulders'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Barbell_Decline_Bench_Press/images/0.jpg`
  },
  {
    id: 'c7', name: 'Chest Dips', nameAr: 'غطس للصدر', muscle: 'Chest', secondaryMuscles: ['Triceps', 'Shoulders'],
    ...
    gifUrl: `${BASE}/Chest_Dip/images/0.jpg`
  },
  {
    id: 'c8', name: 'Machine Chest Press', nameAr: 'دفع صدر جهاز', muscle: 'Chest', secondaryMuscles: ['Triceps', 'Shoulders'],
    ...
    gifUrl: `${BASE}/Lever_Chest_Press/images/0.jpg`
  },
  {
    id: 'c9', name: 'Landmine Press', nameAr: 'دفع لاندماين', muscle: 'Chest', secondaryMuscles: ['Shoulders', 'Triceps'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Landmine_Press/images/0.jpg`
  },
  {
    id: 'c10', name: 'Svend Press', nameAr: 'سفيند بريس (ضغط بالطارة)', muscle: 'Chest', secondaryMuscles: ['Shoulders'],
    ...
    gifUrl: `${BASE}/Svend_Press/images/0.jpg`
  },

  // ============== BACK (Pull) ==============
  {
    id: 'b1', name: 'Pull Ups', nameAr: 'عقلة', muscle: 'Back', secondaryMuscles: ['Biceps', 'Forearms'],
    ...
    gifUrl: `${BASE}/Pull-up/images/0.jpg`
  },
  {
    id: 'b2', name: 'Barbell Row', nameAr: 'سحب بار ظهر', muscle: 'Back', secondaryMuscles: ['Biceps', 'Rear Delts'],
    ...
    gifUrl: `${BASE}/Barbell_Bent_Over_Row/images/0.jpg`
  },
  {
    id: 'b3', name: 'Lat Pulldown', nameAr: 'سحب أمامي عالي', muscle: 'Back', secondaryMuscles: ['Biceps', 'Rear Delts'],
    ...
    gifUrl: `${BASE}/Lat_Pulldown/images/0.jpg`
  },
  {
    id: 'b4', name: 'Deadlift', nameAr: 'رفعة ميتة', muscle: 'Back', secondaryMuscles: ['Legs', 'Glutes', 'Core'],
    ...
    gifUrl: `${BASE}/Barbell_Deadlift/images/0.jpg`
  },
  {
    id: 'b5', name: 'Seated Cable Row', nameAr: 'سحب أرضي', muscle: 'Back', secondaryMuscles: ['Biceps', 'Rear Delts'],
    equipment: 'Cable', difficulty: 'Beginner', category: 'Pull',
    ...
    gifUrl: `${BASE}/Seated_Cable_Row/images/0.jpg`
  },
  {
    id: 'b6', name: 'T-Bar Row', nameAr: 'سحب تي بار', muscle: 'Back', secondaryMuscles: ['Biceps', 'Rear Delts'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Pull',
    ...
    gifUrl: `${BASE}/Lever_T-Bar_Row/images/0.jpg`
  },
  {
    id: 'b7', name: 'Single Arm Dumbbell Row', nameAr: 'سحب دمبل ذراع واحد', muscle: 'Back', secondaryMuscles: ['Biceps', 'Rear Delts'],
    ...
    gifUrl: `${BASE}/Dumbbell_Bent_Over_Row/images/0.jpg`
  },
  {
    id: 'b8', name: 'Face Pull', nameAr: 'سحب بالحب للوجه', muscle: 'Back', secondaryMuscles: ['Rear Delts', 'Rotator Cuff'],
    equipment: 'Cable', difficulty: 'Beginner', category: 'Pull',
    ...
    gifUrl: `${BASE}/Cable_Rear_Delt_Fly/images/0.jpg`
  },
  {
    id: 'b9', name: 'Chin Ups', nameAr: 'عقلة ضيقة', muscle: 'Back', secondaryMuscles: ['Biceps', 'Forearms'],
    ...
    gifUrl: `${BASE}/Chin-Up/images/0.jpg`
  },
  {
    id: 'b10', name: 'Hyperextension', nameAr: 'قطنية (تطويل الظهر)', muscle: 'Back', secondaryMuscles: ['Glutes', 'Hamstrings'],
    ...
    gifUrl: `${BASE}/Hyperextension/images/0.jpg`
  },

  // ============== LEGS ==============
  {
    id: 'l1', name: 'Barbell Squat', nameAr: 'سكوات بالبار', muscle: 'Legs', secondaryMuscles: ['Glutes', 'Core'],
    ...
    gifUrl: `${BASE}/Barbell_Full_Squat/images/0.jpg`
  },
  {
    id: 'l2', name: 'Romanian Deadlift', nameAr: 'رفعة رومانية (خلفيات)', muscle: 'Legs', secondaryMuscles: ['Glutes', 'Lower Back'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Legs',
    ...
    gifUrl: `${BASE}/Barbell_Romanian_Deadlift/images/0.jpg`
  },
  {
    id: 'l3', name: 'Leg Press', nameAr: 'مكبس أرجل', muscle: 'Legs', secondaryMuscles: ['Glutes'],
    ...
    gifUrl: `${BASE}/Sled_45_Leg_Press/images/0.jpg`
  },
  {
    id: 'l4', name: 'Walking Lunges', nameAr: 'طعن حر (لانجز)', muscle: 'Legs', secondaryMuscles: ['Glutes', 'Core'],
    ...
    gifUrl: `${BASE}/Dumbbell_Walking_Lunge/images/0.jpg`
  },
  {
    id: 'l5', name: 'Leg Curl', nameAr: 'رفرفة أرجل خلفية', muscle: 'Legs', secondaryMuscles: ['Calves'],
    equipment: 'Machine', difficulty: 'Beginner', category: 'Legs',
    ...
    gifUrl: `${BASE}/Lever_Lying_Leg_Curl/images/0.jpg`
  },
  {
    id: 'l6', name: 'Leg Extension', nameAr: 'رفرفة أرجل أمامية', muscle: 'Legs', secondaryMuscles: [],
    equipment: 'Machine', difficulty: 'Beginner', category: 'Legs',
    ...
    gifUrl: `${BASE}/Lever_Leg_Extension/images/0.jpg`
  },
  {
    id: 'l7', name: 'Bulgarian Split Squat', nameAr: 'سكوات بلغاري', muscle: 'Legs', secondaryMuscles: ['Glutes', 'Core'],
    ...
    gifUrl: `${BASE}/Dumbbell_Single_Leg_Split_Squat/images/0.jpg`
  },
  {
    id: 'l8', name: 'Hack Squat', nameAr: 'هاك سكوات', muscle: 'Legs', secondaryMuscles: ['Glutes'],
    ...
    gifUrl: `${BASE}/Sled_Hack_Squat/images/0.jpg`
  },
  {
    id: 'l9', name: 'Calf Raise', nameAr: 'سمانة', muscle: 'Legs', secondaryMuscles: [],
    equipment: 'Machine', difficulty: 'Beginner', category: 'Legs',
    ...
    gifUrl: `${BASE}/Lever_Standing_Calf_Raise/images/0.jpg`
  },
  {
    id: 'l10', name: 'Goblet Squat', nameAr: 'سكوات دمبل أمامي', muscle: 'Legs', secondaryMuscles: ['Glutes', 'Core'],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Legs',
    ...
    gifUrl: `${BASE}/Dumbbell_Goblet_Squat/images/0.jpg`
  },

  // ============== SHOULDERS (Push) ==============
  {
    id: 's1', name: 'Overhead Press', nameAr: 'دفع أكتاف بالبار (عسكري)', muscle: 'Shoulders', secondaryMuscles: ['Triceps', 'Core'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Barbell_Standing_Military_Press/images/0.jpg`
  },
  {
    id: 's2', name: 'Lateral Raises', nameAr: 'رفرفة جانبي', muscle: 'Shoulders', secondaryMuscles: [],
    ...
    gifUrl: `${BASE}/Dumbbell_Lateral_Raise/images/0.jpg`
  },
  {
    id: 's3', name: 'Dumbbell Shoulder Press', nameAr: 'دفع أكتاف بالدمبل', muscle: 'Shoulders', secondaryMuscles: ['Triceps'],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Dumbbell_Shoulder_Press/images/0.jpg`
  },
  {
    id: 's4', name: 'Front Raise', nameAr: 'رفرفة أمامي', muscle: 'Shoulders', secondaryMuscles: ['Chest'],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Dumbbell_Front_Raise/images/0.jpg`
  },
  {
    id: 's5', name: 'Reverse Fly', nameAr: 'رفرفة خلفي دمبل', muscle: 'Shoulders', secondaryMuscles: ['Back'],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Pull',
    ...
    gifUrl: `${BASE}/Dumbbell_Rear_Lateral_Raise/images/0.jpg`
  },
  {
    id: 's6', name: 'Arnold Press', nameAr: 'أرنولد بريس', muscle: 'Shoulders', secondaryMuscles: ['Triceps'],
    equipment: 'Dumbbells', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Dumbbell_Arnold_Press/images/0.jpg`
  },
  {
    id: 's7', name: 'Upright Row', nameAr: 'سحب ذقن بالبار', muscle: 'Shoulders', secondaryMuscles: ['Traps'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Pull',
    ...
    gifUrl: `${BASE}/Barbell_Upright_Row/images/0.jpg`
  },
  {
    id: 's8', name: 'Cable Lateral Raise', nameAr: 'رفرفة جانبي بالكابل', muscle: 'Shoulders', secondaryMuscles: [],
    ...
    gifUrl: `${BASE}/Cable_One_Arm_Lateral_Raise/images/0.jpg`
  },
  {
    id: 's9', name: 'Shrugs', nameAr: 'هز أكتاف للترابيس', muscle: 'Shoulders', secondaryMuscles: ['Traps'],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Pull',
    ...
    gifUrl: `${BASE}/Dumbbell_Shrug/images/0.jpg`
  },
  {
    id: 's10', name: 'Behind the Neck Press', nameAr: 'ضغط خلفي بالبار', muscle: 'Shoulders', secondaryMuscles: ['Triceps', 'Traps'],
    ...
    gifUrl: `${BASE}/Barbell_Behind_Neck_Press/images/0.jpg`
  },

  // ============== ARMS ==============
  {
    id: 'a1', name: 'Barbell Curl', nameAr: 'تبادل باي بالبار', muscle: 'Arms', secondaryMuscles: ['Forearms'],
    ...
    gifUrl: `${BASE}/Barbell_Curl/images/0.jpg`
  },
  {
    id: 'a2', name: 'Dumbbell Curl', nameAr: 'تبادل دمبل باي', muscle: 'Arms', secondaryMuscles: ['Forearms'],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Pull',
    ...
    gifUrl: `${BASE}/Dumbbell_Alternate_Biceps_Curl/images/0.jpg`
  },
  {
    id: 'a3', name: 'Hammer Curl', nameAr: 'شاكوش', muscle: 'Arms', secondaryMuscles: ['Forearms', 'Brachialis'],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Pull',
    ...
    gifUrl: `${BASE}/Dumbbell_Hammer_Curl/images/0.jpg`
  },
  {
    id: 'a4', name: 'Tricep Pushdown', nameAr: 'سحب تراي كابل', muscle: 'Arms', secondaryMuscles: [],
    equipment: 'Cable', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Cable_Pushdown/images/0.jpg`
  },
  {
    id: 'a5', name: 'Skull Crushers', nameAr: 'جبهة تراي بالبار', muscle: 'Arms', secondaryMuscles: [],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Barbell_Lying_Triceps_Extension/images/0.jpg`
  },
  {
    id: 'a6', name: 'Tricep Dips', nameAr: 'غطس تراي', muscle: 'Arms', secondaryMuscles: ['Chest', 'Shoulders'],
    ...
    gifUrl: `${BASE}/Triceps_Dip/images/0.jpg`
  },
  {
    id: 'a7', name: 'Preacher Curl', nameAr: 'ارتكاز باي بالبار', muscle: 'Arms', secondaryMuscles: ['Forearms'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Pull',
    ...
    gifUrl: `${BASE}/Barbell_Preacher_Curl/images/0.jpg`
  },
  {
    id: 'a8', name: 'Overhead Tricep Extension', nameAr: 'فرنساوي تراي بالدمبل', muscle: 'Arms', secondaryMuscles: [],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Dumbbell_One_Arm_Triceps_Extension/images/0.jpg`
  },
  {
    id: 'a9', name: 'Concentration Curl', nameAr: 'تبادل ارتكاز باي بالدمبل', muscle: 'Arms', secondaryMuscles: [],
    equipment: 'Dumbbells', difficulty: 'Beginner', category: 'Pull',
    ...
    gifUrl: `${BASE}/Dumbbell_Concentration_Curl/images/0.jpg`
  },
  {
    id: 'a10', name: 'Close Grip Bench Press', nameAr: 'ضغط بنش ضيق للـ تراي', muscle: 'Arms', secondaryMuscles: ['Chest', 'Shoulders'],
    equipment: 'Barbell', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Barbell_Close-Grip_Bench_Press/images/0.jpg`
  },

  // ============== ABS ==============
  {
    id: 'ab1', name: 'Crunches', nameAr: 'بطن كرانش', muscle: 'Abs', secondaryMuscles: [],
    equipment: 'Bodyweight', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Crunch/images/0.jpg`
  },
  {
    id: 'ab2', name: 'Plank', nameAr: 'بلانك', muscle: 'Abs', secondaryMuscles: ['Shoulders', 'Glutes'],
    equipment: 'Bodyweight', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Front_Plank/images/0.jpg`
  },
  {
    id: 'ab3', name: 'Hanging Leg Raise', nameAr: 'رفرفة بطن من التعلق', muscle: 'Abs', secondaryMuscles: ['Hip Flexors'],
    equipment: 'Bodyweight', difficulty: 'Advanced', category: 'Pull',
    ...
    gifUrl: `${BASE}/Hanging_Leg_Raise/images/0.jpg`
  },
  {
    id: 'ab4', name: 'Russian Twist', nameAr: 'تويست للجانبيات', muscle: 'Abs', secondaryMuscles: ['Obliques'],
    equipment: 'Bodyweight', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Russian_Twist/images/0.jpg`
  },
  {
    id: 'ab5', name: 'Cable Crunch', nameAr: 'بطن بالكابل', muscle: 'Abs', secondaryMuscles: [],
    equipment: 'Cable', difficulty: 'Intermediate', category: 'Push',
    ...
    gifUrl: `${BASE}/Cable_Crunch/images/0.jpg`
  },
  {
    id: 'ab6', name: 'Mountain Climbers', nameAr: 'تسلق الجبال', muscle: 'Abs', secondaryMuscles: ['Hip Flexors', 'Shoulders'],
    equipment: 'Bodyweight', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Mountain_Climber/images/0.jpg`
  },
  {
    id: 'ab7', name: 'Ab Rollout', nameAr: 'عجلة البطن', muscle: 'Abs', secondaryMuscles: ['Shoulders', 'Lower Back'],
    ...
    gifUrl: `${BASE}/Ab_Roller/images/0.jpg`
  },
  {
    id: 'ab8', name: 'Bicycle Crunch', nameAr: 'بطن عجلة (بدال)', muscle: 'Abs', secondaryMuscles: ['Obliques'],
    equipment: 'Bodyweight', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Bicycle_Crunch/images/0.jpg`
  },
  {
    id: 'ab9', name: 'Dead Bug', nameAr: 'تمرين الحشرة (كور)', muscle: 'Abs', secondaryMuscles: ['Core'],
    equipment: 'Bodyweight', difficulty: 'Beginner', category: 'Push',
    ...
    gifUrl: `${BASE}/Dead_Bug/images/0.jpg`
  },
  {
    id: 'ab10', name: 'V-Ups', nameAr: 'بطن شكل V', muscle: 'Abs', secondaryMuscles: ['Hip Flexors'],
    equipment: 'Bodyweight', difficulty: 'Intermediate', category: 'Push',
